 ...
 */
public class DeathCPUCharacterHandler implements PropertyChangeListener {
     ...
     */
    public DeathCPUCharacterHandler(GameController controller){
